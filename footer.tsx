      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <KnightIcon className="h-10 w-10 text-primary" />
              <span className="font-serif text-xl font-bold text-foreground">
                SBA Chess Academy
              </span>
            </Link>
            <p className="text-muted-foreground max-w-md mb-6">
              Empowering minds through the art of chess since 2010. Join us on a journey 
              from your first move to tournament victory.
            </p>
            {/* Social Icons */}
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} SBA Chess Academy. All rights reserved.
          </p>
  ...
  return (
    <svg viewBox="0 0 45 45" className={className} fill="currentColor">
      <g>
        ...
        <circle cx="9" cy="25.5" r="0.5" style={{ fill: "var(--background)" }} />
        <ellipse cx="14.5" cy="15.5" rx="0.5" ry="1.5" transform="rotate(30 14.5 15.5)" style={{ fill: "var(--background)" }} />
      </g>
    </svg>
  )
}
